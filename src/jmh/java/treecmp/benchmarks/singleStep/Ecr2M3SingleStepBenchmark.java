...
@Fork(1)
public class Ecr2M3SingleStepBenchmark {
    ...
    private SubtreeEcr2Utils classicEcr2Utils;
    ...
    public void setup() {
        ...
        classicEcr2Utils = new SubtreeEcr2Utils(true); // true = unrooted
        classicBaseM3 = new MatchingTripletMetric();
        incrementalMetric = new Ecr2IncrementalHeuristicM3Metric();

        System.out.println("\n" + "=".repeat(50));
        System.out.println(" WERYFIKACJA 1-KROKU 2-sECR (M3) DLA N: " + treeSize);
        ...
        if (treeSize <= 50) {
            try {
                ...
                Tree[] neighbors = classicEcr2Utils.generateNeighbours(t1);
            ...
            System.out.println("Classic 1-Step M3     : Pominięto weryfikację (Ochrona przed O(N^5))");
        }
        System.out.println("=".repeat(50) + "\n");
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(Ecr2M3SingleStepBenchmark.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}