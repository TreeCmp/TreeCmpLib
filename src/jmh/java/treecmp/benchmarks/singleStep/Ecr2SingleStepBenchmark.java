...
public class Ecr2SingleStepBenchmark {
    ...
    public void setup() {
        ...
        // inkrementalny (np. M3IncrementalMetric) do uniwersalnej heurystyki.
        // =========================================================================
        switch (metricName) {
            case "RF":
        ...
        // SubtreeEcr2Utils przyjmuje boolean "unrooted"
        classicUtils = new SubtreeEcr2Utils(!isRooted);

        System.out.println("\n" + "=".repeat(60));
        System.out.printf(" WERYFIKACJA 2-sECR (%s) DLA ROZMIARU: %d%n", metricName, treeSize);
