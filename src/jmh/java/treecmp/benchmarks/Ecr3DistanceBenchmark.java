...
@Fork(1)
public class Ecr3DistanceBenchmark {
    ...
    public void setup() {
        ...
        // Dynamiczne dobieranie heurystyk KLASYCZNYCH oraz INKREMENTALNYCH dla 3-sECR
        // =========================================================================
        switch (metricName) {
            case "RF":
        ...
        System.out.println("\n" + "=".repeat(60));
        System.out.printf(" WERYFIKACJA PEŁNEGO PRZEBIEGU 3-sECR (%s) DLA ROZMIARU: %d%n", metricName, treeSize);
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(Ecr3DistanceBenchmark.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}