...
public class Ecr3IncrementalHeuristicMSMetric extends IncrementalHeuristicBaseMetric {

    private final SubtreeEcr3Utils ecr3Utils;

    public Ecr3IncrementalHeuristicMSMetric() {
    ...
    public String getName() {
        return "3sECR_IncrementalHeuristic_MS";
    }
}