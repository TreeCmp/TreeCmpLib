...
import treecmp.metrics.topological.acc.MSIncrementalMetric; // Zmiana importu

import java.util.Arrays;

public class Ecr2IncrementalHeuristicMSMetric extends IncrementalHeuristicBaseMetric {

    private final SubtreeEcr2Utils ecr2Utils;

    public Ecr2IncrementalHeuristicMSMetric() {
        // ZMIANA: Wstrzykujemy kalkulator grafów dwudzielnych (MS)
        super(false, new MSIncrementalMetric());
    ...
    private void evaluateEcr2Cluster(Node top, Node m1, Node m2, Node[] boundarySubtrees, boolean isFork) {
        for (TopologyTemplate2sECR template : SubtreeEcr2Utils.getTemplates()) {
            ...
            // incMetric automatycznie zadzwoni do LAP Solvera z MSIncrementalMetric!
    ...
    public String getName() {
        return "2sECR_IncrementalHeuristic_MS";
    }
}