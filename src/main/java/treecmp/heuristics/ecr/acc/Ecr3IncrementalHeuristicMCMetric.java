...
public class Ecr3IncrementalHeuristicMCMetric extends IncrementalHeuristicBaseMetric {

    private final SubtreeEcr3Utils ecr3Utils;

    public Ecr3IncrementalHeuristicMCMetric() {
        super(true, new MCIncrementalMetric()); // Drzewa UKORZENIONE (Rooted)
        this.ecr3Utils = new SubtreeEcr3Utils(false); // false = rooted
    }
    ...
    public String getName() {
        return "3sECR_IncrementalHeuristic_MC";
    }
}