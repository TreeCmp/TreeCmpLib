...
public class Ecr2IncrementalHeuristicMPMetric extends IncrementalHeuristicBaseMetric {

    private final SubtreeEcr2Utils ecr2Utils;

    public Ecr2IncrementalHeuristicMPMetric() {
        super(true, new MPIncrementalMetric()); // Drzewa UKORZENIONE (Rooted)
        this.ecr2Utils = new SubtreeEcr2Utils(false); // false = rooted
    }
    ...
    public String getName() {
        return "2sECR_IncrementalHeuristic_MP";
    }
}