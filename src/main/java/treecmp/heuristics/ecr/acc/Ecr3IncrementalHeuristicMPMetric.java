...
public class Ecr3IncrementalHeuristicMPMetric extends IncrementalHeuristicBaseMetric {

    private final SubtreeEcr3Utils ecr3Utils;

    public Ecr3IncrementalHeuristicMPMetric() {
    ...
    public String getName() {
        return "3sECR_IncrementalHeuristic_MP";
    }
}