...
public class Ecr2IncrementalHeuristicMCMetric extends IncrementalHeuristicBaseMetric {

    private final SubtreeEcr2Utils ecr2Utils;

    public Ecr2IncrementalHeuristicMCMetric() {
    ...
    public String getName() {
        return "2sECR_IncrementalHeuristic_MC";
    }
}