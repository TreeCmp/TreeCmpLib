...
public class MatchingClusterMetric extends BaseMetric implements Metric {
    ...
    private final MatchingClusterMetricO3 mc03;
    private final MatchingClusterMetricOptRF mcRF;
    private final MatchingClusterMetricFree mcFree;

    public MatchingClusterMetric() {
        super();
        this.mc03 = new MatchingClusterMetricO3();
        this.mcRF = new MatchingClusterMetricOptRF();
        this.mcFree = new MatchingClusterMetricFree();
    }
