...
public class MathUtils {
    ...
    /**
     * Returns a new double array in which all the values sum to 1.
     * The relative ratios between elements are preserved.
     *
     * @param array the input array
     * @return a new double array where all the values sum to 1.
     * Relative ratios are preserved.
     * @throws IllegalArgumentException if the sum of the array elements is 0
     */
     ...
     * @param end   the index of the element after the last one to include (exclusive)
     * @return the total of the values in the specified range of the array
     * @throws IllegalArgumentException if the range is invalid
     */
    public static final double getTotal(double[] array, int start, int end) {
        if (start < 0 || end > array.length || start > end) {
            throw new IllegalArgumentException("Invalid range for getTotal");
        }
        double total = 0.0;
     ...
     * @param start the index of the first element to include (inclusive)
     * @param end   the index of the element after the last one to include (exclusive)
     * @return the minimum value in the specified range of the array
     * @throws IllegalArgumentException if the range is invalid
     */
    public static final double getMinimum(double[] array, int start, int end) {
        if (start < 0 || end > array.length || start >= end) {
            throw new IllegalArgumentException("Invalid range for getMinimum");
        }
    ...
    public static final double getMaximum(double[] array, int start, int end) {
        if (start < 0 || end > array.length || start >= end) {
            throw new IllegalArgumentException("Invalid range for getMaximum");
        }
    ...
    /**
     * @param mf a MultivariateFunction defining the number of arguments and their bounds
     * @return a set of valid, but randomly generated, arguments for the function
     */
