...
public class SequenceSimulator {
    ...
    /**
     * Constructs a SequenceSimulator, creating a fresh internal random number generator.
     *
     * @param model The substitution model used for all subsequent sequence simulations.
     * @param sequenceLength The fixed length of all sequences generated by this simulator.
     * @param stochasticDistribution If {@code true}, site categories are assigned randomly based on model probabilities; if {@code false}, they are assigned deterministically.
     */
    ...
    /**
     * Constructs a SequenceSimulator, using the provided random number generator.
     *
     * @param model The substitution model used for all subsequent sequence simulations.
     * @param sequenceLength The fixed length of all sequences generated by this simulator.
     * @param random The random number generator (MersenneTwisterFast) to be used for all stochastic operations.
     * @param stochasticDistribution If {@code true}, site categories are assigned randomly based on model probabilities; if {@code false}, they are assigned deterministically.
     */
    ...
    /**
     * Reassigns the model category/class to each site based on the substitution model's transition category probabilities.
     *
     * @param stochasticDistribution If {@code true}, the assignment is random based on model probabilities; if {@code false}, the assignment is deterministic.
     */
