...
public class ElementParser implements XMLConstants {
     ...
     * @param name The tag name of the desired child element.
     * @return The first child element found with the given name, or {@code null} if none is found.
     */
    ...
    /**
     * Parses an alignment element from an XML document and returns the corresponding alignment object.
     *
     * @param e The XML Element containing the alignment data.
     * @return An {@code Alignment} object.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Parses an attribute element from XML.
     *
     * @param e The XML Element containing the attribute data.
     * @return An {@code Attribute} object.
     * @throws pal.xml.XmlParseException If an error occurs during XML parsing or required attributes are missing.
     */
    ...
    /**
     * Parses a demographic model from a DOM element. Recognizes and converts to:
     * ConstantPopulation, ExponentialGrowth, ConstExpGrowth.
     *
     * @param e The XML Element containing the demographic model.
     * @return A {@code DemographicModel} object.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Parses a tree node from an XML element representing an edge.
     *
     * @param e The XML Element representing the tree edge.
     * @return The tree node ({@code pal.tree.Node}) extracted from the edge element.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
     ...
     *
     * @param element The XML Element containing the frequencies.
     * @return An array of {@code double} values representing the equilibrium frequencies.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
     ...
     *
     * @param e The XML Element containing the mutation rate model.
     * @return A {@code MutationRateModel} object.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Parses a tree node from an XML element.
     *
     * @param e The XML Element representing the node.
     * @return A {@code pal.tree.Node} object parsed from the XML element.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Reads a rate matrix from a DOM document element. Recognizes JC, F81, HKY, GTR.
     * This is a convenience method that calls {@link #parseRateMatrix(Element, Alignment)} with a null alignment.
     *
     * @param e The XML Element containing the rate matrix.
     * @return A {@code RateMatrix} object.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Parses a rate distribution element.
     *
     * @param e The XML Element containing the rate distribution.
     * @return A {@code RateDistribution} object.
     * @throws XmlParseException If an error occurs during XML parsing or the distribution type is unrecognized.
     */
     ...
     *
     * @param e The XML Element containing the rate matrix.
     * @param a An optional {@code Alignment} used to estimate frequencies if they are not explicitly provided in the XML.
     * @return A {@code RateMatrix} object.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Returns a time data object (TimeOrderCharacterData) based on the given XML element.
     *
     * @param e The XML Element containing the time data.
     * @return A {@code TimeOrderCharacterData} object.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Returns a tree object (Tree) based on the XML element passed to it.
     *
     * @param e The XML Element representing the tree.
     * @return A {@code pal.tree.Tree} object.
     * @throws XmlParseException If an error occurs during XML parsing.
     */
    ...
    /**
     * Throws an {@code XmlParseException} if the element does not have
     * the given expected tag name.
     *
     * @param e The XML Element to validate.
     * @param name The expected tag name.
     * @throws XmlParseException If the tag name is incorrect.
     */
    ...
    /**
     * This method checks for the presence of an attribute, serving as a substitute for the DOM Level 2 method
     * {@code e.hasAttribute()}. It is implemented to maintain compliance with DOM Level 1.
     *
     * @param e The DOM Element to check.
     * @param name The name of the attribute to look for.
     * @return {@code true} if the attribute exists and has a non-empty value, otherwise {@code false}.
     */
